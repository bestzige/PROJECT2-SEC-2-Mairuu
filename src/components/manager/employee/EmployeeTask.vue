...
<template>
  <div class="w-full flex justify-center items-center flex-col">
    ...
    <div
      v-else-if="authStore.role === 'employee' || authStore.role === 'admin'"
    ...
    <div v-else class="w-full flex justify-center items-center flex-col my-4">
      <h1 class="text-5xl text-center text-red-500">This page is only for employee</h1>
    </div>
    <XButton to="/" class="mx-auto">Back to home</XButton>
  </div>
</template>
